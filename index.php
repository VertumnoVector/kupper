...
<body>
    ...
    <div class="modal fade" tabindex="-1" id="openFilterModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Selecione o periodo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="filter-form" class="p-2" novalidate>
                        <div class="row mb-3 gx-3">
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
            ...
            <div class="offcanvas-body">
                ...
                <div class="list-group justify-content-center">
                    ...
                    <br>
                    <a href="#" class="list-group-item list-group-item-action disabled text-primary"><span
                            class="material-symbols-outlined bi">menu_book</span> Minhas agendas</a>
                    <a href="#" onclick="fetchAllSchedule()" data-bs-dismiss="offcanvas"
    ...
    <div class="row row-cols-1 my-auto justify-content-center align-items-center" id="welcome">
                ...
                <div class="col-md-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="#" class="list-group-item list-group-item-action disabled" data-bs-toggle="modal"
                                data-bs-target="#">
